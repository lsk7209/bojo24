...
export const DEFAULT_SITE_URL = "https://bojo24.kr";
export const DEFAULT_GA_MEASUREMENT_ID = "G-ZQJVKK37Y2";
export const CONTACT_EMAIL = "contact@bojo24.kr";

export const normalizeSiteUrl = (siteUrl = DEFAULT_SITE_URL): string => {
  const trimmed = siteUrl.replace(/\/$/, "");
  return trimmed === "https://www.bojo24.kr" ? DEFAULT_SITE_URL : trimmed;
};

export const resolveSiteUrl = (
  siteUrl = process.env.NEXT_PUBLIC_SITE_URL
): string => normalizeSiteUrl(siteUrl || DEFAULT_SITE_URL);
